const styles = {
  ...
  // hero section
  heroHeading:
      'font-bold lg:text-[100px] md:text-[75px] sm:text-[60px] text-[34px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[34.4px] uppercase text-white',
  heroDText:
