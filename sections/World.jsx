...
const World = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| Estamos espalhados pelo Brasil" textStyles="text-center" />
      <TitleText
        title={(
          <>
            Nossos alunos estão mudando sua realidade em todas as regiões.
          </>
        )}
      ...
      >
        ...
        <div className=" absolute bottom-20 left-[72%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5d6680]">
